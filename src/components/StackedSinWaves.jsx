...
import { main as stackedMain } from "./stacked_sin_waves.js";

export default function StackedSinWaves() {
  ...
  const charWidth = 9 * 0.35;     // px, matches fontSize 16px
  const charHeight = 16 * 0.35;   // px, matches lineHeight 16px\
